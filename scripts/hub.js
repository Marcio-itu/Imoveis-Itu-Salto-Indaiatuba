...
function hubCss(t) {
  ...
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .wa-share svg{width:16px;height:16px;color:#F15D03}
  ...
  .btn-enviar-site{display:inline-flex;align-items:center;gap:7px;color:#F15D03;text-decoration:none;
    font-size:13px;font-weight:600;border:1px solid rgba(241,93,3,.35);border-radius:999px;
    padding:8px 16px;transition:background .15s,border-color .15s}
  .btn-enviar-site svg{width:14px;height:14px}
  .btn-enviar-site:hover{background:rgba(241,93,3,.08);border-color:#F15D03}
