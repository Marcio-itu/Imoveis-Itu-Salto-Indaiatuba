// test-catalog-fields.js
// Descobre todos os campos obrigatórios e opcionais do catálogo Home Listings
...
async function descobrirCampos() {
  ...
  try {
    ...
    console.error("❌ Erro ao consultar metadados:", err.message);
  }
}
